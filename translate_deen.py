...
class TranslateDeenWmtBpe32k(translate.TranslateProblem):
...
@registry.register_problem
class TranslateDeenWmt8k(translate.TranslateProblem):
...
@registry.register_problem
class TranslateDeenWmt32k(TranslateDeenWmt8k):
...
class TranslateDeenWmt32kPacked(TranslateDeenWmt32k):
  ...
  def vocab_filename(self):
    return TranslateDeenWmt32k().vocab_filename
...
class TranslateDeenWmt8kPacked(TranslateDeenWmt8k):
  ...
  @property
  def vocab_filename(self):
    return TranslateDeenWmt8k().vocab_filename
